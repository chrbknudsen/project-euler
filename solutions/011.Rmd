...
Matricer til subsetting af ting 
```{r}

vandret <- cbind(x = 0, y = 0:3)
lodret <- cbind(x = 0:3, y = 0)
...
ny_max_prod <- function(i,j){
  ...
  liste <- list(position + vandret, position - vandret,
     position + lodret, position - lodret,
